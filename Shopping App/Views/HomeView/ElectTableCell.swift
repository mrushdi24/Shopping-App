...
class ElectTableCell: BaseTableCell {
    ...
    override func setupViews() {
        ...
        productsPresenter.fetchData("\(Api)/category/electronics")
    }
...
extension  ElectTableCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension  ElectTableCell: PoductsProtocol, AddToCartFromMain, AddToBookmark {
