...
class JewelTableCell: BaseTableCell {
    ...
    override func setupViews() {
        ...
        productsPresenter.fetchData("\(Api)/category/jewelery")
...
extension  JewelTableCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension  JewelTableCell: PoductsProtocol, AddToCartFromMain, AddToBookmark {
