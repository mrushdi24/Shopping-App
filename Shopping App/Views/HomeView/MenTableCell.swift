...
class MenTableCell: BaseTableCell {
    ...
    static let ProductCollectionCellIdent = "ProductCollectionCellIdent"
    ...
    override func setupViews() {
        ...
        productsPresenter.fetchData("\(Api)/category/men's%20clothing")
    }
    override func setupCollectionView() {
        collectionView.delegate = self
        collectionView.dataSource = self
        collectionView.register(ProductCollectionCell.self, forCellWithReuseIdentifier: MenTableCell.ProductCollectionCellIdent)
...
extension  MenTableCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.productsPresenter.numberOfRowsInSection()
    }
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MenTableCell.ProductCollectionCellIdent, for: indexPath) as! ProductCollectionCell
...
extension  MenTableCell: PoductsProtocol, AddToCartFromMain, AddToBookmark {
